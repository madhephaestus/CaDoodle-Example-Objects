...
CSG getObject(){
	...
	LengthParameter word = new LengthParameter(csgdb,	args[0]+"_CaDoodle_ToroidSide_Sides",
...
,options)
	LengthParameter top = new LengthParameter(csgdb,	args[0]+"_CaDoodle_ToroidTop_Inner",
		3,[])
	LengthParameter bottom = new LengthParameter(csgdb,	args[0]+"_CaDoodle_ToroidBottom_Outer",
		10,[])
