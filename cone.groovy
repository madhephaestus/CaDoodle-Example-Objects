...
CSG getObject(){
	...
	LengthParameter word = new LengthParameter(csgdb,	args[0]+"_CaDoodle_ConeSide_Sides",
										16,options)
	LengthParameter top = new LengthParameter(csgdb,	args[0]+"_CaDoodle_ConeTop_Top",
		0,[])
	LengthParameter bottom = new LengthParameter(csgdb,	args[0]+"_CaDoodle_ConeBottom_Bottom",
		10,[])
