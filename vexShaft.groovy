...
CSG getObject(){
	if(args==null)
		args=["Test_key_here"]
	StringParameter size = new StringParameter(	"vexShaft"+" Default","6-inch",Vitamins.listVitaminSizes("vexShaft"))	
	...
	if(args.size()>1)if(!args[1].get("PreventBomAdd"))
		CaDoodleFile.getBoM().addVitamin(new VitaminLocation(false,	args[0], "vexShaft" , word.getStrValue(), new TransformNR()),true) 
