...
CSG getObject(){
	if(args==null)
		args=["Test_key_here"]
	StringParameter size = new StringParameter(	"nut"+" Default","M8",Vitamins.listVitaminSizes("nut"))	
	...
	if(args.size()>1)if(!args[1].get("PreventBomAdd"))
		CaDoodleFile.getBoM().addVitamin(new VitaminLocation(false,	args[0], "nut" , word.getStrValue(), new TransformNR()),true) 
